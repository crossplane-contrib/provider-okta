...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-okta.3.11.0
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_NATIVE_PROVIDER_BINARY)
...
xpkg.build.provider-okta: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/oktas/01-delete.yaml.tmpl.
