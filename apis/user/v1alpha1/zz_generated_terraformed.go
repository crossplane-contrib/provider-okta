...
func (tr *User) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"old_password": "spec.forProvider.oldPasswordSecretRef", "password": "spec.forProvider.passwordSecretRef", "recovery_answer": "spec.forProvider.recoveryAnswerSecretRef"}
}
...
// LateInitialize this AdminRoles using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AdminRoles) LateInitialize(attrs []byte) (bool, error) {
	params := &AdminRolesParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
func (mg *BaseSchemaProperty) GetTerraformResourceType() string {
	return "okta_user_base_schema_property"
}
...
// LateInitialize this BaseSchemaProperty using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BaseSchemaProperty) LateInitialize(attrs []byte) (bool, error) {
	params := &BaseSchemaPropertyParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
